...
#         self.tau = 0.01  # for soft update of target parameters
    ...
    def step(self, action, reward, next_state, done):
        ...
        if next_state[2] > self.max_height:
            self.max_height = next_state[2]
            self.best_state = next_state
            
#         if next_state[2] > self.max_height:
#             self.max_height = next_state[2]
#             if self.task.goalsMet[0] != 1.:
#                 self.best_state = next_state
            
#         if next_state[3] > self.max_x:
#             self.max_x = next_state[3]
#             if self.task.goalsMet[0] == 1.:
#                 self.best_state = next_state
...
class Actor:
    ...
    def build_model(self):
        ...
        # Add hidden layers
        #good spike in beginning then has several episodes of crashing between some good episodes, even hits 300m in one
...
#         net = layers.Dense(units=1, activation='relu')(net)
...
class ReplayBuffer:
    ...
    #possibly replace with prioritized replay buffer
